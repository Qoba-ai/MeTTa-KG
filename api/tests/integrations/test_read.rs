...
#[tokio::test]
#[serial]
async fn test_read_existing_empty_namespace() {
    let server = MockServer::start();
    common::setup(&server.base_url());
...
#[tokio::test]
#[serial]
async fn test_read_non_empty_namespace() {
    let server = MockServer::start();
    common::setup(&server.base_url());
...
#[tokio::test]
#[serial]
async fn test_read_different_namespaces() {
    let server = MockServer::start();
    common::setup(&server.base_url());
...
#[tokio::test]
#[serial]
async fn test_read_no_read_permission() {
    let server = MockServer::start();
    common::setup(&server.base_url());
...
#[tokio::test]
#[serial]
async fn test_read_namespace_mismatch() {
    let server = MockServer::start();
    common::setup(&server.base_url());
