  ...
  return (
    <>
      ...
      <main class={styles.Main}>
          ...
          <Show when={editorMode() !== EditorMode.DEFAULT}>
            <div class={styles.MettaInputActionsWrapper}>
              <div class={styles.MettaEditorActions}>
                <button onClick={() => loadSpaceModal.showModal()}>Load</button>
                ...
                <button onclick={() => exportMetta()}>Export</button>
                <button onclick={() => transformModal.showModal()}>
                  Transform
                </button>
                <div style={{ "flex-grow": 1 }}></div>
                <button onclick={() => run()}>
                  <VsRunAll class={styles.RunIcon} size={22} />
                </button>
              </div>
        ...
        <Show when={editorMode() === EditorMode.IMPORT} fallback={<div></div>}>
          <div class={styles.ImportParametersFormWrapper}>
            ...
            >
              ...
              <p class={styles.Instructions}>
                Modify the import parameters as needed before finalizing your
                import.
              </p>
              <Show when={activeImportFileFormat() === ImportFormat.CSV}>
                <label>
                  Scheme
                  <select
                  ...
                  >
                    ...
                    <option value={"CellLabeled"}>Labeled Cell</option>
                    <option value={"CellUnlabeled"}>Unlabeled Cell</option>
                  </select>
                </label>
                <label>
                  Delimiter
              ...
              <input type="submit" value={"Import (coming soon)"} disabled />
            </form>
          </div>
        </Show>
      </main>
      <dialog ref={importFileModal!}>
        <form ref={importFileForm!}>
          <h2>Select File</h2>
          <p>
            The following formats are supported. Files with extensions other
            than the ones listed will not be recognized:
          </p>
          <ul>
            <li>CSV (.csv)</li>
            <li>N3 (.nt3)</li>
      ...
      <dialog ref={loadSpaceModal!} class={styles.LoadSpaceModal}>
        <form ref={loadSpaceForm!}>
          ...
          <div class={styles.ModalButtonBar}>
            ...
            <div style={{ "flex-grow": 1 }}></div>
            <button class={styles.Button} disabled={tokenToOpen() === ""}>
              Open
            </button>
          </div>
        </form>
          ...
          <div class={styles.TransformIOSpaces}>
            <div>
              ...
              <input
                ...
                onchange={(ev) => setTransformInputSpaces(ev.target.value)}
                placeholder="Input"
              />
              <select
                class={styles.SelectSpaces}
            ...
            <div>
              ...
              <input
                ...
                onchange={(ev) => setTransformOutputSpaces(ev.target.value)}
                placeholder="Output"
              />
              <select
                class={styles.SelectSpaces}
            ...
            <div>
              <input
                ...
                placeholder="Pattern"
                onchange={(ev) => setTransformPattern(ev.target.value)}
              />
              <input
                class={styles.SelectSpaces}
                value={transformTemplate()}
                placeholder="Template"
                onchange={(ev) => setTransformTemplate(ev.target.value)}
              />
            </div>
          </div>
          <div class={styles.ModalButtonBar}>
