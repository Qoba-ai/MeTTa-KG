...
const App: Component = () => {
  ...
  const handleMouseClick = (event: MouseEvent) => {
    ...
    if (importCSVModal
      ...
      && importCSVButton && !importCSVButton.contains(event.target as Node)
      && importCSVModal.open) {
    ...
    <div class={styles.App}>
      ...
      <div class={styles.Editor}>
        ...
        <div class={styles.MettaInputWrapper}>
          <textarea class={styles.MettaInput} readonly>{contents()}</textarea>
          <Show when={isNewSession()}>
            <div class={styles.NewSessionDiv}>
              <button ref={popperButton!} onClick={() => setIsCreateNewPopperOpen(!isCreateNewPopperOpen())} class={styles.ImportButton}>
              ...
              <Show when={isCreateNewPopperOpen()}>
                <div ref={popper!} class={styles.CreateNewKGPopOver}>
                  ...
                  <button ref={importCSVButton!} onClick={() => {
                    importCSVModal.showModal();
                    setIsCreateNewPopperOpen(false);
                  }} class={styles.ImportCSVButton}>Import CSV</button>
                </div>
              </Show>
            </div>
          </Show>
